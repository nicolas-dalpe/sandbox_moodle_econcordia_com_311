 ...
 * theme econcordia when working with Bootstrap 4 alpha. We do not recommend
...
class autoprefixer {
    ...
    public function __construct(Document $tree) {
        debugging('theme_econcordia\autoprefixer() is deprecated. Required prefixes for Bootstrap ' .
            'are now in theme/econcordia/scss/moodle/prefixes.scss', DEBUG_DEVELOPER);
        $this->tree = $tree;
