...
* remove folder theme/econcordia/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/econcordia/scss/bootstrap
...
* comment out this line in theme/econcordia/scss/_print.scss
    @page {
...
* remove folder theme/econcordia/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/econcordia/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/econcordia/amd/src
* edit theme/econcordia/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/econcordia run "grunt amd" to compile the bootstrap JS
* in folder theme/econcordia run "grunt css" to compile scss
