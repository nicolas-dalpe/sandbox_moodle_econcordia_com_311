...
/**
 * Privacy tests for theme_econcordia.
 *
...
use \theme_econcordia\privacy\provider;

/**
 * Unit tests for theme_econcordia/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_econcordia_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_econcordia');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_econcordia'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_econcordia'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
